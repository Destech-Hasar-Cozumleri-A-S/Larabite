@props([
    ...
    'success' => null,
    'helper' => null,
    'variant' => 'default', // default, link, bordered, list-group, inline, color
...
@php
    $baseClasses = 'w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600';
    ...
    if ($error) {
        $checkboxClasses = 'w-4 h-4 text-red-600 bg-red-50 border-red-500 rounded focus:ring-red-500 dark:bg-red-100 dark:border-red-400';
    } elseif ($success) {
        $checkboxClasses = 'w-4 h-4 text-green-600 bg-green-50 border-green-500 rounded focus:ring-green-500 dark:bg-green-100 dark:border-green-400';
    } elseif ($variant === 'color') {
        $checkboxClasses = 'w-4 h-4 bg-gray-100 border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600 ' . $colorClasses[$color];
    } else {
