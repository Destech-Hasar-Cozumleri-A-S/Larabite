...
Footer bileşenleri. Her sayfanın altında sitemap linkleri, sosyal medya iconları, copyright ve brand bilgileri göstermek için kullanılır.
...
Temel footer container bileşeni. Tüm footer içeriğini sarar.
...
Başlık ve link listesi içeren section.
