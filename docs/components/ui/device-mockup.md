...
Components for displaying application screenshots and content within different device frames. Mockups that comply with the Flowbite design system, responsive and with dark mode support.
...
Mockup for mobile phone view. Offers 3 different variants.

**Location:** `resources/views/components/ui/device-mockup/smartphone.blade.php`

### Features

- 3 variants: Default, iPhone, Android
...
Mockup for tablet view. Supports portrait and landscape orientations.
...
Mockup for laptop screen view. Keyboard display optional.
...
Desktop computer (iMac style) mockup. Stand and base included.
...
Mockup for smartwatch view. Strap display optional.
