...
Hero/Jumbotron components. Large, eye-catching headlines, descriptions, and CTA buttons for landing pages and section headers.
...
Base hero/jumbotron container component.
