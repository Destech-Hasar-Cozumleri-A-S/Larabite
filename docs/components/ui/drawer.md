...
Off-canvas panel (sidebar) components. Mobil menüler, filtreler, settings panelleri ve navigasyon için kullanılır. Alpine.js ile state management, smooth transitions ve backdrop desteği sunar.
...
Base drawer component. 4 farklı pozisyon desteği ile off-canvas panel.
