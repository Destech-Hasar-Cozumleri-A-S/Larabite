...
Status göstergeleri, count badge'leri ve loading state indicators. Avatarlar, butonlar ve diğer elementlere status bilgisi eklemek için kullanılır.
...
Temel renkli dot indicator. Legend ve status göstergeleri için kullanılır.
