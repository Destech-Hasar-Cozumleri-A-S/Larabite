...
Contextual menu components. Used for user menus, action menus, filters, and notifications. Provides state management and smooth transitions with Alpine.js.
...
Base dropdown container component. Manages open/close state using Alpine.js.
