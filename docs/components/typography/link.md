...
- 4 variants (default, button, card, cta)
- Underline control
...
| `variant` | string | 'default' | default, button, card, cta | Link style variant |
| `underline` | string | 'hover' | always, hover, never | Underline state |
