...
- 5 different variants (default, highlight, mark, gradient, underline)
- Responsive sizing
- Dark mode support
...
|------|------|---------|---------|-------------|
| `level` | int | 1 | 1-6 | Heading level |
| `variant` | string | 'default' | default, highlight, mark, gradient, underline | Heading variant |
| `gradient` | string | 'blue-purple' | blue-purple, cyan-blue, green-blue, purple-pink, teal-lime, red-yellow | Gradient color combination |
| `highlightColor` | string | 'blue' | - | Highlight color |