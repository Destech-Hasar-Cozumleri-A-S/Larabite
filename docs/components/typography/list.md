...
- 4 list types (unordered, ordered, description, unstyled)
...
|------|------|---------|---------|-------------|
| `type` | string | 'unordered' | unordered, ordered, description, unstyled | List type |
| `position` | string | 'inside' | inside, outside | List marker position |
| `spacing` | string | '1' | 1, 2, 4 | Spacing between list items |

## List Item Props

| Prop | Type | Default | Options | Description |
|------|------|---------|---------|-------------|
| `type` | string | 'li' | li, dt, dd | List item HTML element |
| `icon` | slot | optional | - | SVG icon (as slot) |