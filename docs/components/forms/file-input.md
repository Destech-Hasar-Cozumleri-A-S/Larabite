...
Dosya yükleme input alanları için bileşen.
...
- 3 varyant (default, dropzone, dropzone-button)
...
| `size` | string | 'base' | Boyut: base, lg |
| `variant` | string | 'default' | Varyant: default, dropzone, dropzone-button |
...
| `multiple` | boolean | false | Birden fazla dosya seçilebilsin mi? |
| `accept` | string | optional | İzin verilen dosya tipleri |
| `required` | boolean | false | Zorunlu alan göstergesi |

## Variants

### Default
Standart file input butonu

### Dropzone
Drag & drop alanı (dashed border ile)

### Dropzone-Button
Dropzone + browse butonu ile gelişmiş görünüm
