...
Kullanıcıların tarih seçmesini sağlayan bileşenler. Flowbite tasarım sistemine uygun, farklı kullanım senaryoları için çeşitli varyantlar sunar.

> **Not:** Bu bileşenler Flowbite'ın datepicker JavaScript kütüphanesini kullanır. Kullanmadan önce Flowbite datepicker kütüphanesinin yüklü olduğundan emin olun.
...
Standard input field ile calendar seçimi. Tıklandığında calendar popup açılır.

**Location:** `resources/views/components/ui/form/datepicker.blade.php`

### Features

- Calendar icon ile input field
- Popup calendar seçici
- Autohide desteği
- Custom date format
...
Her zaman görünür calendar bileşeni. Input field olmadan direkt calendar gösterir.
...
Başlangıç ve bitiş tarihi seçimi için iki bağlantılı datepicker.
...
Flowbite Datepicker kütüphanesini yüklemeniz gerekiyor:
